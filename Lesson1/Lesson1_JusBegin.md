...
Look at the systems below and say which ones are:
...
* Driving with labeled images → **Supervised**
* Grouping shopping habits → **Unsupervised**
* Robot trial & error → **Reinforcement**
...
* Email Classification → **Decision Tree / Supervised**
* Grouping articles → **K-Means / Unsupervised**
* Drone Landing → **Q-Learning / Reinforcement**
...
* **Teachable Machine by Google** – Drag & drop ML learning (no code)
